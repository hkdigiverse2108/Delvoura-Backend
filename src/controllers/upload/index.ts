...
import { deleteImageSchema, uploadImageSchema } from "../../validation";
...
export const deleteUploadedFile = async (req, res) => {
    ...
    try {
        ...
        if (!parsedUrl.pathname.includes("/images/")) return res.status(HTTP_STATUS.BAD_REQUEST).json(new apiResponse(HTTP_STATUS.BAD_REQUEST, responseMessage?.unsupportedFileType, {}, {}))

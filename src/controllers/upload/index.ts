      ...
      return res
        ...
        .json(
          new apiResponse(
            ...
            responseMessage?.noFileUploaded,
            {},
            {}
          )
        );
    ...
    if (!fs.existsSync(baseDir)) {
      return res
        ...
        .json(
          new apiResponse(
            HTTP_STATUS.OK,
            responseMessage?.getDataSuccess("images"),
            [],
            {}
          )
        );
  ...
  try {
    ...
    if (!parsedUrl.pathname.includes("/images/")) {
      return res
        ...
        .json(
          new apiResponse(
            HTTP_STATUS.BAD_REQUEST,
            responseMessage?.unsupportedFileType,
            {},
            {}
          )
        );
      ...
      return res
        ...
        .json(
          new apiResponse(
            ...
            responseMessage?.getDataNotFound("image"),
            {},
            {}
          )
        );
    ...
    return res
      ...
      .json(
        new apiResponse(
          HTTP_STATUS.OK,
          responseMessage?.deleteDataSuccess("images"),
          {},
          {}
        )
      );
